...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--time_gap', type=int, default=2000,
                        help='time gap for neighbors to compute node features')
    parser.add_argument('--time_feat_dim', type=int,
                        default=100, help='dimension of the time embedding')
    parser.add_argument('--position_feat_dim', type=int,
                        default=172, help='dimension of the position embedding')
    ...
    parser.add_argument('--channel_embedding_dim', type=int,
                        default=50, help='dimension of each channel embedding')
    ...
    parser.add_argument('--patience', type=int, default=10,
                        help='patience for early stopping')  # original value = 20
    parser.add_argument('--val_ratio', type=float,
                        default=0.15, help='ratio of validation set')
    ...
    parser.add_argument('--load_best_configs', action='store_true',
...
def get_node_classification_args():
    ...
    # arguments
    parser = argparse.ArgumentParser(
        'Interface for the node classification task')
    parser.add_argument('--dataset_name', type=str, help='dataset to be used',
                        default='wikipedia', choices=['wikipedia', 'reddit'])
    parser.add_argument('--batch_size', type=int,
                        default=200, help='batch size')
    ...
    assert args.dataset_name in [
        'wikipedia', 'reddit'], f'Wrong value for dataset_name {args.dataset_name}!'
    if args.load_best_configs:
